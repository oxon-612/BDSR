...
#combine two faces
match_image = open("E:/XMJ/3Drebuilding/paper/test/test_file/"+number+"_1.txt", "r")
match_image_sim_class = open("E:/XMJ/3Drebuilding/paper/test/test_file/"+number+"_2.txt", "r")
